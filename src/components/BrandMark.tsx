...
export function GeometricBird({
  ...
  return (
    <svg width={width} height={height} viewBox="0 0 80 64" aria-hidden>
      <defs>
        <radialGradient id="sf-body" cx="35%" cy="30%" r="70%">
          <stop offset="0%" stopColor="#ecfccb" />
          <stop offset="40%" stopColor="#a3e635" />
          <stop offset="100%" stopColor="#365314" />
        </radialGradient>
        <radialGradient id="sf-belly" cx="40%" cy="30%" r="70%">
          <stop offset="0%" stopColor="#f0fdfa" />
          <stop offset="100%" stopColor="#99f6e4" />
        </radialGradient>
        <radialGradient id="sf-wing" cx="30%" cy="25%" r="70%">
          <stop offset="0%" stopColor="#ecfdf5" />
          <stop offset="55%" stopColor="#5eead4" />
          <stop offset="100%" stopColor="#0f766e" />
        </radialGradient>
        <linearGradient id="sf-beak" x1="0" y1="0" x2="1" y2="1">
      ...
      <ellipse
        ...
        strokeWidth="2.5"
      />
      <ellipse cx="38" cy="40" rx="11" ry="9" fill="url(#sf-belly)" />
      <ellipse
        cx="26"
        cy="30"
        rx="11"
